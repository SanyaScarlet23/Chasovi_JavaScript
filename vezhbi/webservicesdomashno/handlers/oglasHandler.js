...
//!Tuka kje gi zapisheme site funkcii a pogore gi vrzavme so shemata so koja ja definiravme nashta data baza
...
exports.updateOglas = async(req,res)=> {
    try{
        const updateOglas = await Oglas.findByIdAndUpdate(
            re.params.id,
            req.body,
            {
                new: true,
